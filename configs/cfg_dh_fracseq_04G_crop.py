...
#model
cfg.model = "mdl_dh_seg_3R" # "mdl_dh_seg_2C"
cfg.backbone = 'seresnext50_32x4d' #'resnest50d'  #'efficientnet-b2'
...
# DATASET
cfg.dataset = "ds_dh_fracseg_3A_crop"
if platform.system() == 'Darwin':
